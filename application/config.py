...
config = {
    ...
    # jinja2 templates
    'webapp2_extras.jinja2': {'template_path': ['templates', 'application/templates', 'admin/templates'],
    ...
    'fb_api_key': '487238447975056',
    'fb_secret': 'd16355aac2e210dffd452dc525b0b645',
    ...
    'captcha_public_key': "6LdXj-oSAAAAAHA-cIdPcTFAqK_RLABtYJla1SEG",
    'captcha_private_key': "6LdXj-oSAAAAAIiu0mrSR-vJu_LRegnBJoPKfY0r",
