	...
	.directive(
		...
		["$timeout", "VG_STATES", "VG_EVENTS", function($timeout, VG_STATES, VG_EVENTS){
			return {
				...
				require: "^videogular",
				transclude: true,
				templateUrl: "/application/js/libs/videogular/plugins/views/controls/controls.html",
				scope: {
					autoHide: "=vgAutohide",
	...
	.directive(
		...
		["VG_STATES", "VG_EVENTS", function(VG_STATES, VG_EVENTS) {
			return {
				restrict: "E",
				require: "^videogular",
				templateUrl: "/application/js/libs/videogular/plugins/views/controls/play-pause-button.html",
				scope: {
					vgPlayIcon: "=",
					vgPauseIcon: "="
				},
	...
	.directive(
		...
		["VG_EVENTS", "VG_UTILS", function(VG_EVENTS, VG_UTILS) {
			return {
				restrict: "E",
				require: "^videogular",
				templateUrl: "/application/js/libs/videogular/plugins/views/controls/volume-bar.html",
				link: function(scope, elem, attr, API) {
	...
	.directive(
		...
		["VG_EVENTS", function(VG_EVENTS) {
			return {
				...
				templateUrl: "/application/js/libs/videogular/plugins/views/controls/mute-button.html",
				link: function(scope, elem, attr, API) {
	...
	.directive(
		...
		["$window", "VG_EVENTS", function($window, VG_EVENTS){
			return {
				...
				templateUrl: "/application/js/libs/videogular/plugins/views/controls/full-screen-button.html",
				link: function(scope, elem, attr, API) {
