...
from application.lib import utils
from application.lib import captcha
from application.lib import i18n
from application.lib import test_helpers
...
class AppTest(unittest.TestCase, test_helpers.HandlerHelpers):
    def setUp(self):
        ...
        self.app.config['webapp2_extras.jinja2']['template_path'] =  [os.path.join(os.path.dirname(application.__file__), '../templates'), os.path.join(os.path.dirname(application.__file__), 'templates')]
